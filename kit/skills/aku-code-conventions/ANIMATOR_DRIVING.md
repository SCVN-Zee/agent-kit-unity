...
A bool persists until code changes it; an unintended re-entry depends on the graph. A consumed trigger cannot represent sustained intent by itself. Choose the parameter and transition lifecycle together.
...
public class PlayerAnimatorController : MonoBehaviour
{
    // Serialized Fields
    //----------------------------------------------------------------------
    [Required] // Odin installed; otherwise assert on the initialization path.
